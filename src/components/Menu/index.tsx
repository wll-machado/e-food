...
export const MenuList: any = [
    { week: 'Destaque da semana', origin: 'Japonesa' , id: 1, note: 4.5, name: 'Hioki Sushi' , menu: [
        {
            name: 'Sashimi',
            price: 28,
    ...
    { week: '', origin: 'Brasileira', id: 2, note: 4.9, name: 'Steak House' , menu: [
      {
          name: 'Picanha',
          price: 65,
  ...
  { week: '', origin: 'Italiana', id: 3, note: 4.8, name: 'La Dolce Vita Trattoria' , menu: [
    {
        name: 'Pizza',
        price: 28,
